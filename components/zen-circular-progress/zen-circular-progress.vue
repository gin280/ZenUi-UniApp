<template>
	<view class="zen-circular-container" :style="{ width: diam + 'px', height: (height || diam) + 'px' }">
		<canvas class="zen-circular-default" :canvas-id="defaultCanvasId" :id="defaultCanvasId" :style="{ width: diam + 'px', height: (height || diam) + 'px' }"
		 v-if="defaultShow"></canvas>
		<canvas class="zen-circular-progress" :canvas-id="progressCanvasId" :id="progressCanvasId" :style="{ width: diam + 'px', height: (height || diam) + 'px' }"></canvas>
		<slot />
	</view>
</template>
...
<style scoped>
	.zen-circular-container,
	.zen-circular-default {
		position: relative;
	}
