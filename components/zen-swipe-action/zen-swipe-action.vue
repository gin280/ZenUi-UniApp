<template>
	<view class="zen-swipeout-wrap">
		<view
			class="zen-swipeout-item"
		...
		>
			<view class="zen-swipeout-content"><slot name="content"></slot></view>
			<view class="zen-swipeout-button-right-group" v-if="actions.length > 0" @touchend.stop="loop">
				<view
					class="zen-swipeout-button-right-item"
			...
			<view
				class="zen-swipeout-button-right-group"
				@touchend.stop="loop"
...
.zen-swipeout-content {
	white-space: nowrap;
	overflow: hidden;
}

.zen-swipeout-button-right-group {
	position: absolute;
	right: -100%;
	top: 0;
	height: 100%;
...
.zen-swipeout-button-right-item {
	height: 100%;
	float: left;
	white-space: nowrap;
	box-sizing: border-box;
