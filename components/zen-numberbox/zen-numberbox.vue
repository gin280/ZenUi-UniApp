<template>
	<view class="zen-numberbox">
		<view class="zen-numbox-icon zen-icon-reduce " :class="[disabled || min>=value?'zen-disabled':'']" @tap="reduce"
		 :style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
		<input type="number" v-model="inputValue" :disabled="disabled" @blur="blur" class="zen-num-input" :style="{color:color,fontSize:size+'rpx',backgroundColor:backgroundColor,height:height+'rpx',width:width+'rpx'}" />
		<view class="zen-numbox-icon zen-icon-plus" :class="[disabled || value>=max?'zen-disabled':'']" @tap="plus" :style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
	</view>
</template>
